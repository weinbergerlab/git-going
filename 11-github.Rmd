...
Once it's published, you can view your repository on GitHub using Repository > View on GitHub from GitHub Desktop menu. Do that and have a look around. You'll see the following sections in your GitHub repository:
...
To really see how collaboration features of Git and GitHub work, you're going to need a collaborator; from here on, you and a collaborator will be going through the tutorial together, so go find a collaborator now.